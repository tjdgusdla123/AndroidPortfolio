    ...
    class InsertThread extends Thread{
        public void run(){
            try{
                //upload 할 주소 만들기
                URL url = new URL(
                        "http://192.168.0.181:8080/mysqlserver" +
                                "/insert");
                ...
                Log.e("itemname", itemnameinput.getText().toString());
                Log.e("price", priceinput.getText().toString());
                Log.e("description", descriptioninput.getText().toString());
