...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    class TextThread extends Thread{
        ...
        public void run(){
            ...
            try{
                //URL 만들
                URL url = new URL(
                        "http://192.168.0.181:8080/mysqlserver/detail?itemid=" + 4);
                //Connection 객체 만들기
    ...
    class ImageThread extends Thread{
        String picturrurl;
        public ImageThread(String picturrurl){
            this.picturrurl=picturrurl;
        }
        @Override
        public void run(){
            try {
                URL url = new URL("http://192.168.0.181:8080/mysqlserver/img/"+picturrurl);
                ...
                Bitmap bitamp = BitmapFactory.decodeStream(is);
                //Message에 저장
                Message message = new Message();
                message.obj=bitamp;
